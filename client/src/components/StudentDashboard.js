  ...
  useEffect(() => {
    const fetchStudentData = async () => {
      ...
      try {
        ...
        const studentResponse = await axios.get('http://localhost:5000/api/student/details', {
        ...
        const notificationsResponse = await axios.get('http://localhost:5000/api/student/notifications', {
          params: { email }, // Pass email as a query parameter
        });
